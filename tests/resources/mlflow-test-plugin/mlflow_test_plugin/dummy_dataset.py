...
from MLForge.types import Schema
from MLForge.types.utils import _infer_schema
from MLForge_test_plugin.dummy_dataset_source import DummyDatasetSource
...
class DummyDataset(Dataset):
    ...
    def _to_dict(self, base_dict: dict[str, str]) -> dict[str, str]:
        ...
        return {
            **base_dict,
            "schema": json.dumps({"MLForge_colspec": self.schema.to_dict()}),
...
def from_dummy(
    ...
    from MLForge.data.dataset_source_registry import resolve_dataset_source
