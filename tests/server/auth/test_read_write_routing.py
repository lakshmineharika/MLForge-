...
from MLForge.server.auth.config import AuthConfig, read_auth_config
...
def test_read_auth_config_without_read_uri(tmp_path):
    ...
    with mock.patch("MLForge.server.auth.config._get_auth_config_path", return_value=str(ini_path)):
