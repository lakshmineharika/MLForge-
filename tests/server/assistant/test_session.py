...
from MLForge.assistant.types import Message
from MLForge.server.assistant.session import Session, SessionManager
...
def test_session_manager_save_and_load(tmp_path):
    import MLForge.server.assistant.session as session_module
