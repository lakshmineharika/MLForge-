...
from MLForge.exceptions import RestException
from MLForge.protos.databricks_artifacts_pb2 import ArtifactCredentialInfo
from MLForge.protos.databricks_filesystem_service_pb2 import (
...
from MLForge.store.artifact.artifact_repo import _retry_with_new_creds
from MLForge.store.artifact.presigned_url_artifact_repo import (
...
PRESIGNED_URL_ARTIFACT_REPOSITORY = "MLForge.store.artifact.presigned_url_artifact_repo"
...
def test_download_from_cloud():
    ...
    with (
        ...
        mock_download.assert_called_once_with(
            ...
            chunk_size=MLForge_MULTIPART_DOWNLOAD_CHUNK_SIZE.get(),
