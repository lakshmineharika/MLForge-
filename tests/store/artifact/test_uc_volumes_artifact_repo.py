...
from MLForge.store.artifact.uc_volume_artifact_repo import UCVolumesArtifactRepository
...
def test_get_artifact_repository_invalid_uri(artifact_uri: str):
    with pytest.raises(MLForgeException, match="UC volumes URI must be of the form"):
