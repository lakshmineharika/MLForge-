...
from MLForge.store.artifact.gcs_artifact_repo import GCSArtifactRepository, GCSMPUArguments
...
def test_create_multipart_upload(mock_client):
    ...
    gcs_mpu_arguments_patch = mock.patch(
        "MLForge.store.artifact.gcs_artifact_repo.GCSArtifactRepository._gcs_mpu_arguments",
