...
import MLForge.store.model_registry.dbmodels.models  # noqa: F401
import MLForge.store.tracking.dbmodels.models  # noqa: F401
import MLForge.store.workspace.dbmodels.models  # noqa: F401
...
WORKSPACE_STORE_PATHS = [
    "MLForge/store/tracking/sqlalchemy_workspace_store.py",
    "MLForge/store/model_registry/sqlalchemy_store.py",
    "MLForge/store/jobs/sqlalchemy_workspace_store.py",
]
