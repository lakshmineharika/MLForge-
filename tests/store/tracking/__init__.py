...
from MLForge.entities import RunTag
from MLForge.models import Model
from MLForge.utils.MLForge_tags import MLForge_LOGGED_MODELS
...
class AbstractStoreTest:
    ...
    def test_record_logged_model(self):
        ...
        self._verify_logged(
            ...
            params=[],
            metrics=[],
            tags=[RunTag(MLForge_LOGGED_MODELS, json.dumps([m.to_dict()]))],
        )
        m2 = Model(
        ...
        self._verify_logged(
            ...
            params=[],
            metrics=[],
            tags=[RunTag(MLForge_LOGGED_MODELS, json.dumps([m.to_dict(), m2.to_dict()]))],
        )
        m3 = Model(
        ...
        self._verify_logged(
            ...
            metrics=[],
            tags=[
                RunTag(MLForge_LOGGED_MODELS, json.dumps([m.to_dict(), m2.to_dict(), m3.to_dict()]))
            ],
        )
        with pytest.raises(
            TypeError,
