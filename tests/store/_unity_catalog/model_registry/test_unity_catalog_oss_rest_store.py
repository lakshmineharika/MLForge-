...
from MLForge.store._unity_catalog.registry.uc_oss_rest_store import UnityCatalogOssStore
...
def store(mock_databricks_uc_oss_host_creds):
    with mock.patch("MLForge.utils.oss_registry_utils.get_oss_host_creds"):
