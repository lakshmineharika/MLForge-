...
from MLForge.environment_variables import MLForge_WORKSPACE
from MLForge.utils.workspace_context import (
    ServerWorkspaceContext,
    WorkspaceContext,
    clear_server_request_workspace,
    get_request_workspace,
)
from MLForge.utils.workspace_utils import (
...
def teardown_function():
    ...
    clear_server_request_workspace()
    os.environ.pop(MLForge_WORKSPACE.name, None)
...
def test_resolve_entity_workspace_falls_back_to_env(monkeypatch):
    ...
    with WorkspaceContext(None):
        pass
    monkeypatch.setenv(MLForge_WORKSPACE.name, "  env-workspace  ")
...
def test_server_workspace_context_does_not_touch_env(monkeypatch):
    ...
    with ServerWorkspaceContext("ctx-workspace"):
        ...
        assert MLForge_WORKSPACE.get_raw() == "env-workspace"
