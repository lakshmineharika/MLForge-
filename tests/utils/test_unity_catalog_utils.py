...
from MLForge.entities.model_registry.model_version_search import ModelVersionSearch
from MLForge.entities.model_registry.registered_model_search import RegisteredModelSearch
...
# ---------------------------------------------------------------------------
# Enriched converters (native /api/2.1 governance + MLForge-enrichment surface). The governance
