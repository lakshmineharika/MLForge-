...
from MLForge.utils.provider_filter import (
...
def test_is_provider_allowed_bedrock_in_allowed_list(monkeypatch):
    monkeypatch.setenv("MLForge_GATEWAY_ALLOWED_PROVIDERS", "bedrock")
...
def test_filter_providers_normalizes_bedrock_alias(monkeypatch):
    monkeypatch.setenv("MLForge_GATEWAY_ALLOWED_PROVIDERS", "bedrock,openai")
