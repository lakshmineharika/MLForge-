...
from MLForge.tracing.provider import trace_disabled
...
def test_strands_autolog_single_trace():
    ...
    MLForge.strands.autolog(disable=True)
    agent("bye")
...
def test_multiple_agents_single_trace():
    ...
    # when we translate the genai semantic conventions into MLForge attributes.
