...
from MLForge.webhooks.delivery import _create_webhook_session
from MLForge.webhooks.ssrf import SSRFProtectedHTTPAdapter, SSRFProtectionError
...
def test_ssrf_error_is_not_retried(loopback_server: int):
    ...
    session = _create_webhook_session()
    with mock.patch("MLForge.webhooks.ssrf.ipaddress.ip_address") as mock_ip:
