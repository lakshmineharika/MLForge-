...
from MLForge.tracking.request_header.databricks_request_header_provider import (
...
def test_databricks_request_header_provider_in_context(
    ...
    with (
        ...
        mock.patch(
            "MLForge.utils.databricks_utils.is_in_databricks_job", return_value=is_in_databricks_job
        ),
        mock.patch("MLForge.utils.databricks_utils.is_in_cluster", return_value=is_in_cluster),
    ):
        assert (
...
def test_databricks_request_header_provider_request_headers(
    ...
    with (
        ...
        mock.patch("MLForge.utils.databricks_utils.is_in_cluster", return_value=is_in_cluster),
        mock.patch("MLForge.utils.databricks_utils.get_notebook_id") as notebook_id_mock,
        mock.patch("MLForge.utils.databricks_utils.get_job_id") as job_id_mock,
        mock.patch("MLForge.utils.databricks_utils.get_job_run_id") as job_run_id_mock,
        mock.patch("MLForge.utils.databricks_utils.get_job_type") as job_type_mock,
        mock.patch("MLForge.utils.databricks_utils.get_cluster_id") as cluster_id_mock,
        mock.patch("MLForge.utils.databricks_utils.get_workload_id") as workload_id_mock,
        mock.patch("MLForge.utils.databricks_utils.get_workload_class") as workload_class_mock,
    ):
