...
import MLForge.tracking.default_experiment.registry
...
from MLForge.tracking.default_experiment.registry import (
...
def test_default_experiment_provider_registry_register_entrypoints():
    ...
    mock_get_group_all.assert_called_once_with("MLForge.default_experiment_provider")
...
def _currently_registered_default_experiment_provider_classes():
    return {
        provider.__class__
        for provider in (
            MLForge.tracking.default_experiment.registry._default_experiment_provider_registry
        )
    }
...
def test_registry_instance_loads_entrypoints():
    ...
    with mock.patch(
        ...
        reload(MLForge.tracking.default_experiment.registry)
...
def test_default_experiment_provider_registry_with_installed_plugin(tmp_path, monkeypatch):
    ...
    from MLForge_test_plugin.default_experiment_provider import PluginDefaultExperimentProvider
