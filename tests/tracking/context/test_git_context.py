...
MOCK_REPO_URL = "git@github.com:MLForge/MLForge.git"
...
def test_git_run_context_tags(patch_script_name, patch_git_repo):
    assert GitRunContext().tags() == {
        MLForge_GIT_COMMIT: MOCK_COMMIT_HASH,
        MLForge_GIT_BRANCH: MOCK_BRANCH_NAME,
        MLForge_GIT_REPO_URL: MOCK_REPO_URL,
    }
