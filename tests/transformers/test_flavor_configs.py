...
from MLForge.transformers import _build_pipeline_from_model_input
from MLForge.transformers.flavor_config import (
    build_flavor_config,
    update_flavor_conf_to_persist_pretrained_model,
)
from MLForge.utils.huggingface_utils import is_valid_hf_repo_id
...
def test_update_flavor_conf_to_persist_pretrained_model_raise_if_already_persisted():
    ...
    with pytest.raises(MLForgeException, match="It appears that the pretrained model weight"):
