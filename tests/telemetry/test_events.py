...
from MLForge.entities.evaluation_dataset import DatasetGranularity, EvaluationDataset
...
from MLForge.entities.issue import Issue, IssueSeverity, IssueStatus
from MLForge.entities.mcp_server import MCPRemoteTransportType, MCPStatus
from MLForge.genai.discovery.entities import DiscoverIssuesResult
...
from MLForge.tracing.attachments import Attachment
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {"flavor": "MLForge.pyfunc", "serialization_format": "cloudpickle"},
        ...
        ({}, None),
        (
            {"flavor": "MLForge.pyfunc", "uses_uv": True},
            {"flavor": "pyfunc", "uses_uv": True},
        ),
        (
            {"flavor": "MLForge.pyfunc", "uses_uv": False},
            {"flavor": "pyfunc"},
        ),
        (
            {"uses_uv": True},
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Trace records
        (
            {"records": [{"inputs": {"question": "What is MLForge?", "context": "docs"}}]},
