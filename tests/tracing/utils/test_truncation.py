...
from MLForge.tracing.utils.truncation import _get_truncated_preview, set_request_response_preview


@pytest.fixture(autouse=True)
def patch_max_length():
    # Patch max length to 50 to make tests faster
    with patch("MLForge.tracing.utils.truncation._get_max_length", return_value=50):
        yield
