import MLForge
from MLForge.entities import Link
...
def test_start_span_with_links():
    ...
    with MLForge.start_span(name="linked_span", links=links) as span:
...
def test_start_span_without_links():
    with MLForge.start_span(name="no_links_span") as span:
        span.set_outputs("done")
...
def test_links_persist_through_store_roundtrip():
    ...
    with MLForge.start_span(name="roundtrip_span", links=links) as span:
