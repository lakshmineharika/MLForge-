...
from MLForge.environment_variables import MLForge_TRACE_ARCHIVAL_CONFIG
from MLForge.exceptions import MLForgeException
from MLForge.tracing.trace_archival_config import get_trace_archival_server_config
...
def test_get_trace_archival_server_config_rejects_null_location(monkeypatch, tmp_path):
    ...
    with pytest.raises(MLForgeException, match="trace_archival.location") as exc_info:
...
def test_get_trace_archival_server_config_rejects_null_retention(monkeypatch, tmp_path):
    ...
    with pytest.raises(MLForgeException, match="trace_archival.retention") as exc_info:
        get_trace_archival_server_config()
