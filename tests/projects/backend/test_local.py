...
from MLForge.projects.backend.local import _get_docker_artifact_storage_cmd_and_envs
...
def test_docker_s3_artifact_cmd_and_envs_from_env(monkeypatch):
    mock_env = {
        ...
        "MLForge_S3_ENDPOINT_URL": "mock_endpoint",
        "MLForge_S3_IGNORE_TLS": "false",
    }
...
def test_docker_s3_artifact_cmd_and_envs_from_home(monkeypatch):
    for name in [
        ...
        "AWS_ACCESS_KEY_ID",
        "MLForge_S3_ENDPOINT_URL",
        "MLForge_S3_IGNORE_TLS",
    ]:
...
def test_docker_hdfs_artifact_cmd_and_envs_from_home(monkeypatch):
    mock_env = {
        "MLForge_KERBEROS_TICKET_CACHE": "/mock_ticket_cache",
        "MLForge_KERBEROS_USER": "mock_krb_user",
        "MLForge_PYARROW_EXTRA_CONF": "mock_pyarrow_extra_conf",
    }
...
def test_docker_local_artifact_cmd_and_envs():
    ...
    container_path_expected = "/MLForge/projects/code/mlruns"
