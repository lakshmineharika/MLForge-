...
You're sending traces to a Databricks workspace (`MLForge_TRACKING_URI={{ tracking_uri }}`).
...
by a UC Delta table (requires `MLForge>=3.11` and a SQL warehouse), ask for
...
- MLForge tracing from a local IDE:
  https://docs.databricks.com/aws/en/MLForge3/genai/getting-started/tracing/tracing-ide
...
- Workspace experiment paths:
  https://docs.databricks.com/aws/en/MLForge/experiments
