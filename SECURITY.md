...
MLForge and its community take security bugs seriously. We appreciate efforts to improve the security of MLForge
...
The latest version of MLForge has continued support. If a critical vulnerability is found in the current version
of MLForge, we may opt to backport patches to previous versions.
