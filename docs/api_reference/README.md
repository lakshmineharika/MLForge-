# MLForge API Documentation

This directory contains the MLForge API reference. The source code (`.rst` files) is relatively minimal, as the API docs are mainly populated by docstrings in the MLForge Python source.

## Building the docs

First, install dependencies for building docs as described in the [Environment Setup and Python configuration](https://github.com/MLForge/MLForge/blob/master/CONTRIBUTING.md#environment-setup-and-python-configuration) section of the main MLForge contribution guide.
...
([dev-env-setup.sh](https://github.com/MLForge/MLForge/blob/master/dev/dev-env-setup.sh)),
...
here](https://github.com/MLForge/MLForge/blob/v0.9.1/docs/source/python_api/MLForge.tracking.rst#MLForgetracking)
for an example.
