...
Like the other LightGBM example, we enable autologging for LightGBM scikit-learn models via `MLForge.lightgbm.autolog()`. Saving / loading models also supports LightGBM scikit-learn models.
