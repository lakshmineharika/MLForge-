...
This example demonstrates hyperparameter optimization with MLForge tracking using pure PyTorch (no Lightning dependencies).

## What it demonstrates

- **MLForge nested runs**: Parent run tracks the overall HPO experiment, child runs track individual trials
...
### Using MLForge projects

```bash
MLForge run . -P n_trials=5 -P max_epochs=3
```

## Viewing results

After running, view the results in MLForge UI:
