...
This example demonstrates how to use the Unity Catalog (UC) integration with MLForge AI Gateway.
...
```bash
pip install MLForge openai databricks-sdk
```
...
export MLForge_ENABLE_UC_FUNCTIONS=true
