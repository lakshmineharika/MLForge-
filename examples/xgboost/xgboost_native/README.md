...
Then you can open the MLForge UI to track the experiments and compare your runs via:
...
```
MLForge run . -P learning_rate=0.2 -P colsample_bytree=0.8 -P subsample=0.9
```
