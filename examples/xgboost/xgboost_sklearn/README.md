...
Like the other XGBoost example, we enable autologging for XGBoost scikit-learn models via `MLForge.xgboost.autolog()`. Saving / loading models also supports XGBoost scikit-learn models.
