### MLForge evaluation Examples

The examples in this directory demonstrate how to use the `MLForge.evaluate()` API. Specifically,
they show how to evaluate a PyFunc model on a specified dataset using the builtin default evaluator
and specified extra metrics, where the resulting metrics & artifacts are logged to MLForge Tracking.
