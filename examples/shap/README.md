...
Examples demonstrating use of the `MLForge.shap` APIs for model explainability.
...
```
pip install MLForge scikit-learn shap matplotlib
```
...
- Run `MLForge server` to launch the MLForge UI.
