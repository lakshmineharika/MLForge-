...
```bash
# Fetch the full diff
uv run --package skills skills fetch-diff https://github.com/MLForge/MLForge/pull/123

# Fetch only Python files
uv run --package skills skills fetch-diff https://github.com/MLForge/MLForge/pull/123 --files '*.py'

# Fetch only frontend files
uv run --package skills skills fetch-diff https://github.com/MLForge/MLForge/pull/123 --files 'MLForge/server/js/*'

# Multiple patterns
uv run --package skills skills fetch-diff https://github.com/MLForge/MLForge/pull/123 --files '*.py' '*.ts'
```
